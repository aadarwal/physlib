...
against a side normal — and it measures the incident and transmitted angles into the
**positive**
...
lemma norm_meridionalDirection {d : ℕ} (plane : OrientedAffineHyperplane d)
  ...
  have horth :
      inner ℝ (Real.cos α • plane.sideNormalVector side) (Real.sin α • tangent) = 0 := by
...
lemma cos_angleToSide_meridionalDirection {d : ℕ} (plane : OrientedAffineHyperplane d)
    (side : OrientedAffineHyperplane.Side) (tangent : EuclideanSpace ℝ (Fin d)) (α : ℝ)
    (htangentNorm : ‖tangent‖ = 1) (htangentNormal : plane.normalComponent tangent = 0) :
    Real.cos (plane.angleToSide side (meridionalDirection plane side tangent α)) =
      Real.cos α := by
...
-/
lemma angleToSide_meridionalDirection {d : ℕ} (plane : OrientedAffineHyperplane d)
    (side : OrientedAffineHyperplane.Side) (tangent : EuclideanSpace ℝ (Fin d)) (α : ℝ)
    (htangentNorm : ‖tangent‖ = 1) (htangentNormal : plane.normalComponent tangent = 0)
...
lemma angleToSide_meridionalDirection_signedIncidenceAngle {d : ℕ}
    (plane : OrientedAffineHyperplane d) (side : OrientedAffineHyperplane.Side)
...
lemma vectorReflection_meridionalDirection {d : ℕ} (plane : OrientedAffineHyperplane d)
    (side : OrientedAffineHyperplane.Side) (tangent : EuclideanSpace ℝ (Fin d)) (α : ℝ)
...
-/
lemma angleToSide_vectorReflection_meridionalDirection {d : ℕ}
    (plane : OrientedAffineHyperplane d) (side : OrientedAffineHyperplane.Side)
...
-/
lemma abs_paraxialSnell_sub_le_snellLaw
...
-/
lemma exactRefractionAngle_incidentPhaseAngle
    {configuration : PlanarDielectricWaveConfiguration}
    (h : configuration.IsElectricPhaseMatched)
    (reference : Electromagnetism.HomogeneousIsotropicMedium)
    (hIncidentDispersion : configuration.incident.IsDispersionMatched
...
lemma incidentPhaseAngle_eq_signedIncidenceAngle
...
lemma transmittedPhaseAngle_eq_exactRefractionAngle_signedIncidenceAngle
    {configuration : PlanarDielectricWaveConfiguration} {r : MeridionalRay} {normalAngle : ℝ}
    {tangent : EuclideanSpace ℝ (Fin 3)}
    (h : configuration.IsElectricPhaseMatched)
    (reference : Electromagnetism.HomogeneousIsotropicMedium)
...
-/
lemma abs_paraxialSnell_sub_le_snellLaw_meridional
    {configuration : PlanarDielectricWaveConfiguration} {r : MeridionalRay} {normalAngle : ℝ}
    {tangent : EuclideanSpace ℝ (Fin 3)}
    (h : configuration.IsElectricPhaseMatched)
    (reference : Electromagnetism.HomogeneousIsotropicMedium)
...
-/
lemma realisesIncidentPhaseDirection_incidenceRay
    (configuration : PlanarDielectricWaveConfiguration)
...
-/
lemma realisesIncidentPhaseDirection_of_tangentialProjection_eq_zero
    {configuration : PlanarDielectricWaveConfiguration}
    (tangent : EuclideanSpace ℝ (Fin 3))
...
-/
lemma exists_realisesIncidentPhaseDirection
    (configuration : PlanarDielectricWaveConfiguration)
    (h : configuration.interface.plane.tangentialProjection
      configuration.incident.waveVector.phaseVector ≠ 0) :
...
actually uses.
-/
lemma transmitted_phaseVector_mem_meridionalPlaneSpan
    {configuration : PlanarDielectricWaveConfiguration}
    (h : configuration.IsElectricPhaseMatched)
...
-/
lemma reflected_electricAmplitude_eq_zero_or_phaseVectors_mem_meridionalPlaneSpan
    {configuration : PlanarDielectricWaveConfiguration}
    (h : configuration.IsElectricPhaseMatched)
    (hTangential : configuration.interface.plane.tangentialProjection
      configuration.incident.waveVector.phaseVector ≠ 0) :
